...
function HamburgerMenu() {
  ...
  return (
    <div className="flex items-center">
      ...
      {open && (
        <div className="absolute right-0 top-16 mt-2 w-48 bg-white text-gray-800 rounded shadow-lg z-50 flex flex-col">
...
const Navbar = () => {
  return (
    <div className="select-none font-mono flex flex-row justify-between items-center p-4 bg-gray-400 text-white">
      ...
      <section>
        <ul className="flex flex-row gap-4 space-x-4 text-lg font-mono mr-10">
