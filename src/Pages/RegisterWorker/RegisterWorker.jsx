    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-100 font-mono">
      <div className="flex flex-row w-full max-w-3xl border-2 rounded-xl overflow-hidden bg-white">
        ...
        <div className="flex-1 p-10 flex flex-col justify-center">
          <h2 className="text-2xl md:text-3xl font-bold mb-2 text-gray-900">Register as Worker</h2>
          <p className="text-gray-500 mb-8 text-sm">Create your worker account</p>
          <form onSubmit={handleSubmit} className="w-full">
            <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="text" name="username" value={form.username} onChange={handleChange} required placeholder="Enter your username" className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400" />
              </div>
              <div>
              ...
              <div>
                ...
                <input type="text" name="phone" value={form.phone} onChange={handleChange} required placeholder="Enter your number" className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400" />
              </div>
            </div>
            <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
            ...
            <div className="mb-4 grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                ...
                <input type="password" name="confirmPassword" value={form.confirmPassword} onChange={handleChange} required placeholder="Confirm your password" className="w-full border border-gray-300 rounded px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-400" />
              </div>
            </div>
            <div className="mb-6">
